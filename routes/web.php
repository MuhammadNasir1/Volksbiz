...
Route::middleware('custom')->group(function () {
    ...
    Route::post('/updateExperience/{id}', [ExperienceReviewController::class, 'updateExperience']);
    Route::post('/updateReview/{id}', [ExperienceReviewController::class, 'updateReview']);

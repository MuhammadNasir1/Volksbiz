                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex gap-5  items-center justify-center">
                                        ...
                                        <a href="../editSubscription/{{ $data->id }}"><svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle opacity="0.1" cx="18" cy="18" r="18" fill="#233A85"/>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M16.1634 23.6197L22.3139 15.666C22.6482 15.2371 22.767 14.7412 22.6556 14.2363C22.559 13.7773 22.2768 13.3408 21.8534 13.0097L20.8208 12.1895C19.922 11.4747 18.8078 11.5499 18.169 12.3701L17.4782 13.2663C17.3891 13.3785 17.4114 13.544 17.5228 13.6343C17.5228 13.6343 19.2684 15.0339 19.3055 15.064C19.4244 15.1769 19.5135 15.3274 19.5358 15.508C19.5729 15.8616 19.3278 16.1927 18.9638 16.2379C18.793 16.2605 18.6296 16.2078 18.5107 16.11L16.676 14.6502C16.5868 14.5832 16.4531 14.5975 16.3788 14.6878L12.0185 20.3314C11.7363 20.6851 11.6397 21.1441 11.7363 21.588L12.2934 24.0035C12.3231 24.1314 12.4345 24.2217 12.5682 24.2217L15.0195 24.1916C15.4652 24.1841 15.8812 23.9809 16.1634 23.6197ZM19.5956 22.8672H23.5926C23.9826 22.8672 24.2998 23.1885 24.2998 23.5835C24.2998 23.9794 23.9826 24.2999 23.5926 24.2999H19.5956C19.2056 24.2999 18.8884 23.9794 18.8884 23.5835C18.8884 23.1885 19.2056 22.8672 19.5956 22.8672Z" fill="#233A85"/>
                                            </svg>
                                            </a>

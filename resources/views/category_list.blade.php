...
<x-modal id="categoryModal">
    ...
    <x-slot name="body">
        <form id="addCategory" url="saveCities" method="post">
            @csrf
            <div class="m-5 grid grid-cols-2 gap-4">
                <x-file-uploader id="categoryImage" name="category_image"></x-file-uploader>
                <x-input id="categoryName" label="{{ __('lang.Category') }}" placeholder="{{ __('lang.Category') }}"

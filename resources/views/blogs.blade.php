...
<div id="addcustomermodal" data-modal-backdrop="static"
    ...
    <div class="relative p-4 w-full  rounded-2xl  max-w-6xl max-h-full ">
            ...
            <div class="relative bg-white shadow-dark rounded-lg  dark:bg-gray-700  ">
                ...
                <div class="p-5">
                    ...
                    <div class=" flex gap-20 mt-5 items-center">
                        <label for="blog_title">@lang('lang.Title')</label>
                    ...
                    <div class="w-full  lg:gap-9 mt-5 lg:items-center flex lg:flex-row flex-col">
                        <div class="lg:w-[50%] w-full flex items-center gap-14">

                            <label for="blog_author">@lang('lang.Author')</label>
                            <input type="text" required
                                class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary
                              h-[40px] text-[14px]"
                        ...
                        <div class="lg:w-[50%] w-full flex items-center gap-8 lg:gap-6 lg:mt-0 mt-5">
                            <label for="blog_category">@lang('lang.Category')</label>
                            <select
                    ...
                    <div class=" flex gap-5 mt-5 ">
                        <label class="" for="blog_detail">@lang('lang.Description')</label>
                        <textarea name="blog_detail" id="blog_detail"
                            class="w-full h-28  border-[#DEE2E6] rounded-[4px] focus:border-primary text-[14px] "
                            placeholder="@lang('lang.Enter_Details')"></textarea>
                    </div>
            ...
            <div class="relative bg-white shadow-dark rounded-lg  dark:bg-gray-700  ">
                ...
                <div class=" p-5 w-full ">
                    ...
                    <div class="px-10 py-7 w-full">
                        ...
                        <h3 class="text-[14px] text-[#13242C]">By Gabie Sheber, Mar. 28, 2020</h3>
                        <p class="text-[#C0C0C0] text-[17px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Duis id
                            convallis urna. Pellentesque
                            feugiat lacus vel orci viverra, at rutrum mauris eleifend. Maecenas ultrices elit lectus,
                            non viverra lorem tempus in.Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Duis id convallis urna. Pellentesque feugiat lacus vel orci viverra, at rutrum mauris
                            eleifend. Maecenas ultrices elit lectus, non viverra lorem tempus in.Lorem ipsum dolor sit
